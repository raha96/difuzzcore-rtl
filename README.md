...
**Basic test:**
```
make SIM_BUILD=outputs/build VFILE=SmallBoomTile_v_1.2_state TOPLEVEL=BoomTile NUM_ITER=10 OUT=output/out
```

**Simple verbose:**
```
make SIM_BUILD=outputs/build VFILE=SmallBoomTile_v_1.2_state TOPLEVEL=BoomTile NUM_ITER=10 OUT=output/out RECORD=1 DEBUG=1
```
